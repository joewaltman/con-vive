...
interface CalBookingConfirmationEmailProps {
  guestName: string;
  dinnerDate: string;
  dinnerTime: string;
  address: string;
...
export default function CalBookingConfirmationEmail({
  guestName,
  dinnerDate,
  dinnerTime,
  address,
  ...
  outlookCalendarUrl,
  icsDownloadUrl,
}: CalBookingConfirmationEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>Your spot at the Cal Alumni dinner is confirmed!</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Your spot at the Cal Alumni dinner is confirmed. We can&apos;t wait
            to see you there.
          </Text>
