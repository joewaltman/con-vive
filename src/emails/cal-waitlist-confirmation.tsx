...
interface CalWaitlistConfirmationEmailProps {
  guestName: string;
  dinnerDate: string;
}

export default function CalWaitlistConfirmationEmail({
  guestName,
  dinnerDate,
}: CalWaitlistConfirmationEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>You&apos;re on the waitlist for the Cal Alumni dinner</Preview>
      <Body style={main}>
        <Container style={container}>
          <Text style={coBrand}>
            San Diego Cal Alumni Club × Con-Vive
          </Text>
          ...
          <Text style={text}>
            Thanks for your interest in the Cal Alumni dinner on {dinnerDate}.
