...
import { CalCoBrandHeader } from "@/components/cal/CalCoBrandHeader";
import { CalSignupFormWrapper } from "@/components/cal/CalSignupFormWrapper";
      ...
      <main>
        ...
        <div className="mx-auto max-w-2xl px-6 py-24 text-center">
          ...
          <p className="body-lg mt-4 text-warm-gray">
            The Cal Alumni dinner is not currently available.
          </p>
        </div>
        <Footer />
      </main>
    ...
    <main>
      ...
      <div className="mx-auto max-w-2xl px-6 py-12 sm:py-24">
        ...
        <p className="body-lg mt-4 text-center text-warm-gray">
          Join fellow Cal alumni for an evening of great food and conversation.
        </p>
