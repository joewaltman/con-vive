import { getCalDinner } from "@/lib/cal-dinner";
...
export default async function CalThankYouPage({
  searchParams,
}: {
    ...
    <main>
      ...
      <div className="mx-auto max-w-2xl px-6 py-12 sm:py-24">
        ...
        <div className="text-center">
          ...
          <p className="body-lg mt-4 text-warm-gray">
            Your spot at the Cal Alumni dinner is confirmed.
          </p>
        </div>
